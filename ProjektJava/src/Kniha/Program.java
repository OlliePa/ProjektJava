    ...
    public static void main(String[] args) throws SQLException {
        ...
        while (true) {
            ...
            try {
                ...
                switch (moznost) {
                    case 1:
                        ...
                        if (TypKnihy == 1) {
                            ...
                            String[] Zaner = scanner.nextLine().split(",");
                    ...
                    case 2:
                        ...
                        System.out.println("3. Zaner");
                        moznost = scanner.nextInt();
                        scanner.nextLine();
                        switch (moznost) {
                            case 1:
                                System.out.print("Vlozte autorov oddelenych ciarkov: ");
                                String newAutori = scanner.nextLine();
                                knihovnica.editKniha(NazovKnihyEdit, 1,newAutori);
                                break;

                            case 2:
                                System.out.print("Rok vydania knihy: ");
                                String newRokVydania = scanner.nextLine();
                                scanner.nextLine();
                                knihovnica.editKniha(NazovKnihyEdit, 2, newRokVydania);
                                break;

                            case 3:
                                System.out.print("Je tato kniha dostupna? (true/false): ");
                                String newDostupnost = scanner.nextLine();
                                scanner.nextLine();
                                knihovnica.editKniha(NazovKnihyEdit, 3, newDostupnost);
                                break;
                ...
                System.out.println("!!!!!!!!!Zadali ste zly vstup, skuste to znova!!!!!!!!!!");
                scanner.nextLine();
            }
        }
    }
